...
List<DrawerItems> items=[
  DrawerItems(icon: Icons.book, title: 'Literature', nextpage: LiteraturePage()),
  DrawerItems(icon: Icons.restaurant, title: 'Cuisine', nextpage: Cuisine()),
  DrawerItems(icon: Icons.handyman, title: 'Handicrafts', nextpage: Handicraft()),
  DrawerItems(icon: Icons.location_on, title: 'Destinations', nextpage: Destination()),
  DrawerItems(icon: Icons.theater_comedy, title: 'Culture', nextpage: Culture()),
];