...
List<BookShape> poetry = [
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '16',
          finalPath: 'assets/Literature/Poetry/museeki.jpg',
          bookName: 'Museeki',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '173',
          finalPath: 'assets/Literature/Poetry/rasol.jpg',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '192',
          finalPath: 'assets/Literature/Poetry/shamas.jpg',
      ...
      imagepath: 'assets/Literature/Poetry/shamas.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'POETRY',
          lang: 'KASHMIRI',
          pages: '489',
          finalPath: 'assets/Literature/Poetry/mehjoor.jpg',
      ...
      imagepath: 'assets/Literature/Poetry/mehjoor.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'POETRY',
          lang: 'KASHMIRI',
          pages: '200',
          finalPath: 'assets/Literature/Poetry/kral.jpg',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '146',
          finalPath: 'assets/Literature/Poetry/argami.jpg',
          bookName: 'Argami',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '229',
          finalPath: 'assets/Literature/Poetry/rahim.jpg',
      ...
      imagepath: 'assets/Literature/Poetry/rahim.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'POETRY',
          lang: 'KASHMIRI',
          pages: '72',
          finalPath: 'assets/Literature/Poetry/fakir.jpg',
          ...
          descriptionText:
              'Shamas Faqir ( شمس فقیر) was a Kashmiri Sufi poet. He belonged to the Qadiriyya silsila of Sufism. Shamas Faqir was born in 1843, to a poor family in Chinkral Mohalla, Habba Kadal Srinagar, Kashmir. He didn\'t receive formal education but became apprenticed to Niama Saeb, a Kashmiri Sufi poet. He became a disciple of Souch Maliar, Abdul Rehman of Barzulla, Atiq-Ullah of Gulab Bagh, Mohammad Jammal, and Rasool Saeb. When he was 25, he left for Amritsar, in the Indian Punjab, where he became a disciple of another Sufi Saint.[who?] After his return from Amritsar, he lived in Anantnag, Kashmir, where he married. He returned to his ancestral home in Srinagar for some time, subsequently meditating for six months in a cave at Qazi Bagh in the Budgam district of Kashmir. Following this he lived in Braripora Krishpora. Many of his poems are on the theme of a mystic\'s quest for the primal cause of the universe. Shamas Faqir\'s poems used the Kashmiri idiom of his time and words from Persian, Arabic, and Sanskrit. His poem Merajnama recounts Prophet Muhammad’s spiritual journey to God. Shamas Faqir died in 1901 and was buried at Krishpora Shamasabad Budgam Kashmir. He had two sons and a daughter.[1] Shamas Faqir\'s grand sons Sheikh Peer Mehraj ud din (Aasi Shamas) and his younger brother Sheikh Peer Mohammad Altaf (sons of Sheikh Peer Gh Mohidin Sahib (RAH) kami wali presently at his place. Sheikh Peer Mehraj ud din (aasi shamas) is also a poet (shayar).'),
      imagepath: 'assets/Literature/Poetry/fakir.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'POETRY',
          lang: 'KASHMIRI',
          pages: '59',
          finalPath: 'assets/Literature/Poetry/wali.jpg',
...
List<BookShape> history = [
  BookShape(
      name: BookTemplate(
        ...
        finalPath: 'assets/Literature/History/KashmirAlas.jpg',
        link:
            'https://drive.google.com/file/d/12P49VpcwBhX0Zd2WGw3La91YMdgpJnwa/view?usp=sharing',
      ),
      imagepath: 'assets/Literature/History/KashmirAlas.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'ENGLISH',
        ...
        finalPath: 'assets/Literature/History/HinduRulers.jpg',
        link:
            'https://drive.google.com/file/d/1fqKP6Ngkko9KgvBXCOuGXR0gdIMQwrTZ/view?usp=sharing',
      ),
      imagepath: 'assets/Literature/History/HinduRulers.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'KASHMIRI',
        ...
        finalPath: 'assets/Literature/History/Struggle.jpg',
        link:
            'https://drive.google.com/file/d/1DSNEBDY3gOabEWSauYNs46NYXD7Smjhj/view?usp=sharing',
      ),
      imagepath: 'assets/Literature/History/Struggle.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'ENGLISH',
        ...
        finalPath: 'assets/Literature/History/KashmirHistory.jpg',
        link:
            'https://drive.google.com/file/d/1L51gNjpzZfTGeowlRNO86bfpjBILL5k4/view?usp=sharing',
      ),
      imagepath: 'assets/Literature/History/KashmirHistory.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'HISTORY',
          lang: 'ENGLISH',
          ...
          finalPath: 'assets/Literature/History/Rajantarangni.jpg',
          link:
              'https://drive.google.com/file/d/1-_LjlaMk65876p_ofw72FflpVGkirLxg/view?usp=sharing'),
      imagepath: 'assets/Literature/History/Rajantarangni.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'ENGLISH',
        ...
        finalPath: 'assets/Literature/History/ValleyOfKashmir.jpg',
        link:
            'https://drive.google.com/file/d/1gyRXbPRPZqJ2p8raAA58H2X0Dl1HkdQg/view?usp=sharing',
      ),
      imagepath: 'assets/Literature/History/ValleyOfKashmir.jpg'),
];
...
List<BookShape> prose = [
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '200',
          finalPath: 'assets/Literature/Prose/RaaiTraai.jpg',
          bookName: 'RAAI TRAAI',
      ...
      imagepath: 'assets/Literature/Prose/RaaiTraai.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '124',
          finalPath: 'assets/Literature/Prose/TyothPazr.jpg',
      ...
      imagepath: 'assets/Literature/Prose/TyothPazr.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '175',
          finalPath: 'assets/Literature/Prose/Akhyaadakhqayamat.jpg',
      ...
      imagepath: 'assets/Literature/Prose/Akhyaadakhqayamat.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '103',
          finalPath: 'assets/Literature/Prose/Hawas.jpg',
          bookName: 'HAWAS',
          author: 'Abdul Ahad Hajini',
          link:
      ...
      imagepath: 'assets/Literature/Prose/Hawas.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '313',
          finalPath: 'assets/Literature/Prose/rahman.jpg',
          bookName: 'KHEWAT',
          author: 'Rahman Rahi',
          link:
      ...
      imagepath: 'assets/Literature/Prose/rahman.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '107',
          finalPath: 'assets/Literature/Prose/DiltiDewar.jpg',
      ...
      imagepath: 'assets/Literature/Prose/DiltiDewar.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '290',
          finalPath: 'assets/Literature/Prose/Yetinooresarearzwasamaa.jpg',
      ...
      imagepath: 'assets/Literature/Prose/Yetinooresarearzwasamaa.jpg'),
];
...
List<BookShape> newbook = [
  BookShape(
      name: BookTemplate(
          ...
          lang: 'ENGLISH',
          pages: '285',
          finalPath: 'assets/Literature/New/thecollaborator.jpg',
      ...
      imagepath: 'assets/Literature/New/thecollaborator.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'MEMOIR',
          lang: 'ENGLISH',
          pages: '258',
          finalPath: 'assets/Literature/New/curfewednight.jpg',
      ...
      imagepath: 'assets/Literature/New/curfewednight.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'BIOGRAPHY',
          lang: 'ENGLISH',
          pages: '200',
          finalPath: 'assets/Literature/New/ourmoonhasbloodclots.jpg',
          bookName: 'OUR MOON HAS BLOOD CLOTS',
          author: 'Rahul Pandita',
          link:
              'https://drive.google.com/file/d/1Zn4Ld1s0Gm8uJxQ2N7asYP7n0SRwqxRk/view?usp=drivesdk',
          descriptionText: ''),
      imagepath: 'assets/Literature/New/ourmoonhasbloodclots.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'HISTORY',
          lang: 'ENGLISH',
          pages: '382',
          finalPath: 'assets/Literature/New/kashmiradisputedlegacy.jpg',
          bookName: 'KASHMIR A DISPUTED LEGACY',
          author: 'Alstair Lamb',
          link:
      ...
      imagepath: 'assets/Literature/New/kashmiradisputedlegacy.jpg'),
];
