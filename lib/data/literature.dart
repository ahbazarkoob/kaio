...
List<BookShape> poetry = [
  BookShape(
      name: BookTemplate(
          genre: 'POETRY',
          lang: 'KASHMIRI',
          pages: '16',
          finalPath: 'assets/images/Literature/Poetry/museeki.jpg',
          bookName: 'Museeki',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '173',
          finalPath: 'assets/images/Literature/Poetry/rasol.jpg',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '192',
          finalPath: 'assets/images/Literature/Poetry/shamas.jpg',
      ...
      imagepath: 'assets/images/Literature/Poetry/shamas.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'POETRY',
          lang: 'KASHMIRI',
          pages: '489',
          finalPath: 'assets/images/Literature/Poetry/mehjoor.jpg',
      ...
      imagepath: 'assets/images/Literature/Poetry/mehjoor.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'POETRY',
          lang: 'KASHMIRI',
          pages: '200',
          finalPath: 'assets/images/Literature/Poetry/kral.jpg',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '146',
          finalPath: 'assets/images/Literature/Poetry/argami.jpg',
          bookName: 'Argami',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '229',
          finalPath: 'assets/images/Literature/Poetry/rahim.jpg',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '72',
          finalPath: 'assets/images/Literature/Poetry/fakir.jpg',
  ...
  BookShape(
      name: BookTemplate(
          ...
          lang: 'KASHMIRI',
          pages: '59',
          finalPath: 'assets/images/Literature/Poetry/wali.jpg',
...
List<BookShape> history = [
  BookShape(
      name: BookTemplate(
        ...
        finalPath: 'assets/images/Literature/History/KashmirAlas.jpg',
        link:
            'https://drive.google.com/file/d/12P49VpcwBhX0Zd2WGw3La91YMdgpJnwa/view?usp=sharing',
      ),
      imagepath: 'assets/images/Literature/History/KashmirAlas.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'ENGLISH',
        ...
        finalPath: 'assets/images/Literature/History/HinduRulers.jpg',
        link:
            'https://drive.google.com/file/d/1fqKP6Ngkko9KgvBXCOuGXR0gdIMQwrTZ/view?usp=sharing',
      ),
      imagepath: 'assets/images/Literature/History/HinduRulers.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'KASHMIRI',
        ...
        descriptionText:
            'This book is different from many that have been written on Kashmir during the past sixty years since the dispute started. It is not a propagandists book; it does not present the problem of Kashmir or suggest a solution as would cater to the predisposition and wishful thinking of any party of community.',
        finalPath: 'assets/images/Literature/History/Struggle.jpg',
        link:
            'https://drive.google.com/file/d/1DSNEBDY3gOabEWSauYNs46NYXD7Smjhj/view?usp=sharing',
      ),
      imagepath: 'assets/images/Literature/History/Struggle.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'ENGLISH',
        ...
        finalPath: 'assets/images/Literature/History/KashmirHistory.jpg',
        link:
            'https://drive.google.com/file/d/1L51gNjpzZfTGeowlRNO86bfpjBILL5k4/view?usp=sharing',
      ),
      imagepath: 'assets/images/Literature/History/KashmirHistory.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'HISTORY',
          lang: 'ENGLISH',
          ...
          descriptionText:
              'Rajatarangini (Sanskrit: राजतरङ्गिणी, romanized: rājataraṅgiṇī, IPA: [ɾɑː.d͡ʑɐ.t̪ɐˈɾɐŋ.ɡi.ɳiː], "The River of Kings") is a metrical legendary and historical chronicle of the north-western part of India, particularly the kings of Kashmir. It was written in Sanskrit by Kashmiri historian Kalhana in the 12th century CE.[3] The work consists of 7826 verses, which are divided into eight books called tarangas ("waves"). The Rajatarangini provides the earliest source on Kashmir that can be labeled as a "historical" text on this region. Although inaccurate in its chronology, the book still provides a valuable source of information about early Kashmir and its neighbors in the northwestern parts of the Indian subcontinent and has been widely referenced by later historians and ethnographers.',
          finalPath: 'assets/images/Literature/History/Rajantarangni.jpg',
          link:
              'https://drive.google.com/file/d/1-_LjlaMk65876p_ofw72FflpVGkirLxg/view?usp=sharing'),
      imagepath: 'assets/images/Literature/History/Rajantarangni.jpg'),
  BookShape(
      name: BookTemplate(
        genre: 'HISTORY',
        lang: 'ENGLISH',
        ...
        finalPath: 'assets/images/Literature/History/ValleyOfKashmir.jpg',
        link:
            'https://drive.google.com/file/d/1gyRXbPRPZqJ2p8raAA58H2X0Dl1HkdQg/view?usp=sharing',
      ),
      imagepath: 'assets/images/Literature/History/ValleyOfKashmir.jpg'),
];

List<BookShape> prose = [
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '200',
          finalPath: 'assets/images/Literature/Prose/RaaiTraai.jpg',
          bookName: 'RAAI TRAAI',
      ...
      imagepath: 'assets/images/Literature/Prose/RaaiTraai.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '124',
          finalPath: 'assets/images/Literature/Prose/TyothPazr.jpg',
      ...
      imagepath: 'assets/images/Literature/Prose/TyothPazr.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '175',
          finalPath: 'assets/images/Literature/Prose/Akhyaadakhqayamat.jpg',
      ...
      imagepath: 'assets/images/Literature/Prose/Akhyaadakhqayamat.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '103',
          finalPath: 'assets/images/Literature/Prose/Hawas.jpg',
          bookName: 'HAWAS',
          author: 'Abdul Ahad Hajini',
          link:
      ...
      imagepath: 'assets/images/Literature/Prose/Hawas.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '313',
          finalPath: 'assets/images/Literature/Prose/rahman.jpg',
          bookName: 'KHEWAT',
          author: 'Rahman Rahi',
          link:
      ...
      imagepath: 'assets/images/Literature/Prose/rahman.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '107',
          finalPath: 'assets/images/Literature/Prose/DiltiDewar.jpg',
      ...
      imagepath: 'assets/images/Literature/Prose/DiltiDewar.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'PROSE',
          lang: 'KASHMIRI',
          pages: '290',
          finalPath: 'assets/images/Literature/Prose/Yetinooresarearzwasamaa.jpg',
      ...
      imagepath: 'assets/images/Literature/Prose/Yetinooresarearzwasamaa.jpg'),
];

List<BookShape> newbook = [
  BookShape(
      name: BookTemplate(
          genre: 'FICTION',
          lang: 'ENGLISH',
          pages: '285',
          finalPath: 'assets/images/Literature/New/thecollaborator.jpg',
      ...
      imagepath: 'assets/images/Literature/New/thecollaborator.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'MEMOIR',
          lang: 'ENGLISH',
          pages: '258',
          finalPath: 'assets/images/Literature/New/curfewednight.jpg',
      ...
      imagepath: 'assets/images/Literature/New/curfewednight.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'BIOGRAPHY',
          lang: 'ENGLISH',
          pages: '200',
          finalPath: 'assets/images/Literature/New/ourmoonhasbloodclots.jpg',
          bookName: 'OUR MOON HAS BLOOD CLOTS',
          author: 'Rahul Pandita',
          link:
              'https://drive.google.com/file/d/1Zn4Ld1s0Gm8uJxQ2N7asYP7n0SRwqxRk/view?usp=drivesdk',
          descriptionText: ''),
      imagepath: 'assets/images/Literature/New/ourmoonhasbloodclots.jpg'),
  BookShape(
      name: BookTemplate(
          genre: 'HISTORY',
          lang: 'ENGLISH',
          pages: '382',
          finalPath: 'assets/images/Literature/New/kashmiradisputedlegacy.jpg',
          bookName: 'KASHMIR A DISPUTED LEGACY',
          author: 'Alstair Lamb',
          link:
      ...
      imagepath: 'assets/images/Literature/New/kashmiradisputedlegacy.jpg'),
];
