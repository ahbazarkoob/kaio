...
List<RecipeImage> beverages = [
  RecipeImage(
    ...
    assetName: 'assets/images/Cuisine/Beverages/kehwa.jpg',
  ),
  RecipeImage(
    ...
    assetName: 'assets/images/Cuisine/Beverages/KashmiriNoonChai.jpg',
  ),
  RecipeImage(
    ...
    assetName: 'assets/images/Cuisine/Beverages/Babribyol.jpg',
  ),
  RecipeImage(
    ...
    assetName: 'assets/images/Cuisine/Beverages/KesarDoodh.jpg',
  ),
  RecipeImage(
    ...
    assetName: 'assets/images/Cuisine/Beverages/KashmiriLassi.jpg',
  ),
  RecipeImage(
    recipeName: 'KANJI',
    name: Recipe(
    ...
    assetName: 'assets/images/Cuisine/Beverages/KashmiriKanji.jpg',
  ),
  RecipeImage(
    recipeName: 'GUD CHAI',
    name: Recipe(
    ...
    assetName: 'assets/images/Cuisine/Beverages/KashmiriGudChai.jpg',
  ),
];
...
List<RecipeImage> homemade = [
  RecipeImage(
    ...
    recipeName: 'Kashmiri Rajma',
    assetName: 'assets/images/Cuisine/HomeMade/Rajma.jpeg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    recipeName: '\t Kashmiri Al Yakni',
    assetName: 'assets/images/Cuisine/HomeMade/Alyakhni.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    assetName: 'assets/images/Cuisine/HomeMade/KashmiriLaalPaneer.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    recipeName: 'Dum Aloo',
    assetName: 'assets/images/Cuisine/HomeMade/KashmiriDumAloo.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    recipeName: 'Kashmiri Saag',
    assetName: 'assets/images/Cuisine/HomeMade/saag.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    assetName: 'assets/images/Cuisine/HomeMade/khatteBhaingan.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    assetName: 'assets/images/Cuisine/HomeMade/Gaad.jpeg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    assetName: 'assets/images/Cuisine/HomeMade/KashmiriDahiBaingan.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    assetName: 'assets/images/Cuisine/HomeMade/MuttonYakni.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'HOME MADE',
    ...
    assetName: 'assets/images/Cuisine/HomeMade/MonjeMaaz.jpg',
  ),
];
...
List<RecipeImage> wazwan = [
  RecipeImage(
    ...
    recipeName: 'Rogan Josh',
    assetName: 'assets/images/Cuisine/Wazwan/RoganJosh.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'WAZWAN',
    ...
    recipeName: 'Rista',
    assetName: 'assets/images/Cuisine/Wazwan/rista.jpeg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'WAZWAN',
    ...
    recipeName: 'Goshtaba',
    assetName: 'assets/images/Cuisine/Wazwan/Goshtaba.jpg',
  ),
  RecipeImage(
    name: Recipe(
        Category: 'WAZWAN',
        ...
        itemCount: 9),
    recipeName: 'Tabak Maaz',
    assetName: 'assets/images/Cuisine/Wazwan/TabakMaaz.jpeg',
  ),
  RecipeImage(
    name: Recipe(
        Category: 'WAZWAN',
        ...
        itemCount: 14),
    recipeName: 'Daniwal korma',
    assetName: 'assets/images/Cuisine/Wazwan/DaniwalKorma.jpeg',
  ),
  RecipeImage(
    name: Recipe(
        Category: 'WAZWAN',
    ...
    assetName: 'assets/images/Cuisine/Wazwan/LahabiKebab.jpeg',
  ),
  RecipeImage(
    name: Recipe(
        Category: 'WAZWAN',
    ...
    assetName: 'assets/images/Cuisine/Wazwan/AabGosht.jpg',
  ),
];
...
List<RecipeImage> deserts = [
  RecipeImage(
    ...
    recipeName: 'KESAR PHIRNI',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriKesarPhirni.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'APPLE KHEER',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriAppleKheer.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'KASHMIRI LYDE',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriLyde.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'SEVAIYAN',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriSevaiyan.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'FALOODA',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriFalooda.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'SHUFTA',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriShufta.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'KASHMIRI HALWA',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriHalwa.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'BASRAKH',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriBasrakh.jpg',
  ),
  RecipeImage(
    name: Recipe(
      Category: 'DESSERTS',
    ...
    recipeName: 'TOSHA',
    assetName: 'assets/images/Cuisine/Deserts/KashmiriTosha.jpg',
  ),
];
